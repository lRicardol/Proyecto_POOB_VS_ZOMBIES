...
public class selectorDePlantas extends JFrame {
     ...
     */
    public selectorDePlantas() {
        setTitle("Jugando Modo Horda");
        ...
        availablePlants.add(new Sunflower(null, 0, 1));
        availablePlants.add(new Peashooter(null, 0, 1));
        availablePlants.add(new WallNut(null, 0, 1));
        availablePlants.add(new TallNut(null, 0, 1));
        availablePlants.add(new PotatoMine(null, 0, 1));
        availablePlants.add(new ECIPlant(null, 0, 1));
