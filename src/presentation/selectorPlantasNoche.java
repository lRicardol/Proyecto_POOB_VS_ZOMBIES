...
public class selectorPlantasNoche extends JFrame {
    ...
    public selectorPlantasNoche() {
        ...
        originalIcon = new ImageIcon("src/resources/selectorplantanoche.png");
    ...
    private void startGame() {
        ...
        Nivel3Noche.stopMusic();
        LoadingScreen.stopMusic();
        SwingUtilities.invokeLater(() -> {
            dispose();
            new Nivel3Noche(selectedPlants);
        });
    }
}
