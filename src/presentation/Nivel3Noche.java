...
public class Nivel3Noche extends JFrame {
    ...
    public Nivel3Noche(List<Plant> selectedPlants) {
        ...
        originalIcon = new ImageIcon("src/resources/backgroundnoche.png");
    ...
    private void createGridPanel(JLayeredPane layeredPane, int windowWidth, int windowHeight) {
        ...
        for (int row = 0; row < 5; row++) {
            for (int col = 0; col < 10; col++) {
                ...
                if (col == 0) {
                    LawnMower lawnMower = new LawnMower(currentRow, layeredPane, board.getZombiesInRow(currentRow), null, this, null, null);
